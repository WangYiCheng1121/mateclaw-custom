export default {
  ...
  settings: {
    ...
    model: {
      ...
      claudeCodeOauthRevokeHint: '请在 Claude Code 客户端中退出登录。GLClaw 不会修改 Claude Code 的本地凭据。',
  ...
  acp: {
    ...
    env: {
      ...
      hints: {
        ...
        dashscope: '阿里云 DashScope key — 跟 GLClaw .env 里的 DASHSCOPE_API_KEY 同一个值',
  ...
  login: {
    ...
    heroDesc: 'GLClaw 的重点不是把更多能力堆进聊天框，而是把上下文、知识、执行和记忆收拢成一个可靠的工作面。',
  ...
  channels: {
    ...
    webchatHint: 'WebChat 用于把 GLClaw 聊天挂件嵌入外部网站。请配置 API Key、标题和主题色，然后在网站中引入 WebChat SDK。',
