export default {
  ...
  settings: {
    ...
    model: {
      ...
      claudeCodeOauthRevokeHint: 'Sign out from the Claude Code app to revoke. GLClaw does not modify Claude Code\'s on-disk credentials.',
  ...
  acp: {
    ...
    env: {
      ...
      hints: {
        ...
        dashscope: 'Aliyun DashScope key — same value as GLClaw .env DASHSCOPE_API_KEY',
  ...
  login: {
    ...
    heroDesc: 'GLClaw is not about stuffing more capability into a chat box. It is about pulling context, knowledge, execution, and memory into one reliable operating surface.',
  ...
  channels: {
    ...
    webchatHint: 'WebChat embeds the GLClaw chat widget into external websites. Configure an API key, title, and primary color, then load the WebChat SDK on your site.',
  ...
  toolLabels: {
    ...
    readGLClawDoc: 'Read System Docs',
