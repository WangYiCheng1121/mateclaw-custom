---
title: GLClaw 项目介绍 — 自部署多智能体 AI 操作系统
description: GLClaw 是基于 Spring AI Alibaba 的开源多智能体 AI 操作系统。ReAct + Plan-and-Execute 双引擎、LLM Wiki 知识库、四层记忆系统、MCP 工具协议、8 渠道统一接入。一个 JAR 包自部署，数据不出门。
head:
  - - meta
    - name: keywords
      content: GLClaw,多智能体,AI操作系统,自部署AI,Spring AI Alibaba,ReAct,Plan-and-Execute,MCP,LLM Wiki,记忆系统,Tool Guard,开源
---

# GLClaw — 自部署多智能体 AI 操作系统

**你的多智能体 AI，跑在你自己的机器上，按你自己的规则。**

GLClaw 是一整套可以自部署的 AI 操作系统。一个 JAR 包，一套登录，数据不出门。
...
GLClaw 换了一个打法：**所有东西放在一个屋檐下，跑在你自己能摸到的硬件上。**
...
把 GLClaw 跑在你自己的机器上，不是合规打个勾那么简单。它改变的是这个产品**到底是什么**。
