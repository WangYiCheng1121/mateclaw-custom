...
- Subscriptions persist to `~/.glclaw/webhook_subscriptions.json`

## How It Works

1. `the agent webhook subscribe` writes to `~/.glclaw/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook ~/.glclaw/logs/gateway.log | tail -20`
