...
CREATE INDEX IF NOT EXISTS idx_agent_mcp_agent ON mate_agent_mcp(agent_id);
CREATE UNIQUE INDEX IF NOT EXISTS uk_agent_mcp ON mate_agent_mcp(agent_id, mcp_ref_id);
